          ...
          >
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <span className=" text-[1.2rem] font-semibold text-gray-300 sm:text-base">
                  Hubnex Lab
                </span>
                ...
                I join the Hubnex Lab in March 2024 as a intern, then i got an more experience for project. just like how to create a project with team work then how to deploy. 
                Then i got live project for work. me and my team did complate the project.
                <br />
                Worked on multiple projects.
                <br />
                I worked on Hubnex Techfund Landing Page
                </p>
              </div>
            </div>
          </fieldset>
          ...
          >
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <span className=" text-[1.1rem] font-semibold text-gray-300 sm:text-base">
                  RTMNU
                </span>
                <span className=" text-[.9rem] font-semibold text-yellow-500 sm:text-base">
